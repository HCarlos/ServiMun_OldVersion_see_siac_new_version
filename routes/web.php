...
Route::group(['middleware' => 'role:auth|Administrator|SysOp|USER_OPERATOR_SIAC|USER_OPERATOR_ADMIN|ENLACE'], function () {
...
//    Route::get('editDenuncia/{Id}', 'Denuncia\DenunciaController@editItemV2')->name('editDenuncia');
