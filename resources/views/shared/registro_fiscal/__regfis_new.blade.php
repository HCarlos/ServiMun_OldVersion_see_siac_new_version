<div class="form-group row mb-3">
    ...
    <div class="col-md-9">
        <input type="text" name="razon_social" id="razon_social" value="{{ old('razon_social') }}" class="form-control" required />
    </div>
</div>
<div class="form-group row mb-3">
    <label for = "rfc" class="col-md-3 col-form-label">RFC</label>
    <div class="col-md-9">
        <input type="text" name="rfc" id="rfc" value="{{ old('rfc') }}" class="form-control" pattern="^[A-ZÑ&]{3,4}\d{6}(?:[A-Z\d]{3})?$" required />
    </div>
</div>
<div class="form-group row mb-3">
    ...
    <div class="col-md-9">
        <input type="text" name="ps_id" id="ps_id" value="{{ old('ps_id') }}" class="form-control" />
    </div>
</div>
