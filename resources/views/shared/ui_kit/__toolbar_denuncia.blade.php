...
<div class="button-list mt-md-2">
    @isset($newItem)
        <a href="{{route($newItem)}}"  @isset($newWindow) target="_blank" @endisset class="btn btn-light btn-sm ml-3" data-toggle="tooltip" data-placement="top" data-original-title="Nueva Denuncia">
