...
//        dd($items);
        ...
        return view('catalogos.dependencias.dependencia.dependencia_list',
            [
                'items' => $items,
...
// ***************** EDITA LOS DATOS  ++++++++++++++++++++ //
    protected function editDependencia($Id)
    {
        ...
        return view('catalogos.dependencias.dependencia.dependencia_edit',
            [
                'user' => Auth::user(),
                'jefes' => $Jefes,
                'items' => $item,
...
// ***************** GUARDA LOS CAMBIOS ++++++++++++++++++++ //
    ...
    protected function newDependencia()
    {
        ...
        return view('catalogos.dependencias.dependencia.dependencia_new',
            [
                'editItemTitle' => 'Nuevo',
                'jefes' => $Jefes,
